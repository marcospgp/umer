...
\begin{figure}
  \centering
      \includegraphics[width=0.5\textwidth]{janela_registados}}
...
\begin{figure}
  \centering
      \includegraphics[width=0.5\textwidth]{criar_cliente}}
...
Junto do botão para criação de um Cliente existe também o botão "Registar Condutor", através do qual será possível criar um novo Condutor. Obviamente, a posição do motorista não tem interesse, pelo que não é pedida.
  \centering
      \includegraphics[width=0.5\textwidth]{criar_condutor}}
...
\begin{figure}
  \centering
      \includegraphics[width=0.5\textwidth]{criar_veiculo}}
