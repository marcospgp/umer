...
public class GUI extends JFrame {
	...
	private boolean isAvailable; // Se o condutor logado atualmente est� dispon�vel
	private JLabel driverAvailableLabel;
	private JLabel driverUnavailableLabel;
	
	// Formul�rio de iniciar viagem
	...
	public GUI() {
		...
		lblStartTrip.setBorder(new EmptyBorder(10, 0, 10, 0));
		...
		pnlStartTripForm.setMaximumSize(new Dimension(32767, 300));
		...
		lblPendingRatings.setBorder(new EmptyBorder(10, 0, 10, 0));
		...
		pnlLoggedInDriverAvailableContainer.setBorder(new EmptyBorder(10, 0, 0, 0));
	...
	public void updateVehicles(String[] vehicles) {
		this.clearVehicles();
