...
public class CreateVehicleDialog extends JDialog {
	...
	public CreateVehicleDialog() {
		...
		}
		{
			...
			listTypes.setModel(new AbstractListModel() {
				String[] values = new String[] {"ababa", "werewr"};
				public int getSize() {
			...
			GridBagConstraints gbc_listTypes = new GridBagConstraints();
			gbc_listTypes.insets = new Insets(0, 0, 5, 0);
			gbc_listTypes.fill = GridBagConstraints.HORIZONTAL;
			gbc_listTypes.gridx = 3;
			gbc_listTypes.gridy = 0;
			contentPanel.add(listTypes, gbc_listTypes);
		}
		{
	...
	public String[] getResult() {
		...
		result[1] = listType.getSelectedIndex() // TODO
